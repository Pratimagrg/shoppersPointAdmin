        ...
        <form className="row g-3" onSubmit={addProduct}>
          ...
          <div className="col-md-6">
            ...
            <input
              ...
              onChange={(e) => {
                setAvailabilityQuantity(e.target.value);
              }}
            />
          </div>
          ...
          <div>
            {catDefaultFile.length > 0 &&
              catDefaultFile.map((file, index) => {
    ...
    <Modal show={show} onHide={onHide} centered>
      ...
      <Modal.Body>
        ...
        <div className="col-12">
          ...
          <button onClick={onHide} type="button" className="btn btn-danger">
            Cancel
          </button>
        </div>
      </Modal.Body>
